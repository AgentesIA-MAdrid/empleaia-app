...
import { LayoutDashboard, Users, FileText, LogOut, MessageSquare, KeyRound, ShieldCheck, Send } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-1 text-sm">
              ...
              <NavLink href="/admin/telegram" icon={Send}>Telegram</NavLink>
              <NavLink href="/admin/admins" icon={ShieldCheck}>Admins</NavLink>
