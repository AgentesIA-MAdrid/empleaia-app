...
export const FEATURE_COVERAGE: readonly CoverageEntry[] = [
  ...
  // Arqueos semanales, PIN de recogida y conciliación: entrega 4 del módulo.
  { endpointGlob: "arqueos/**/route.ts", featureKey: "cierre_turno", guard: "withFeature" },
  { endpointGlob: "conciliacion/**/route.ts", featureKey: "cierre_turno", guard: "withFeature" },
  { endpointGlob: "movimientos-banco/**/route.ts", featureKey: "cierre_turno", guard: "withFeature" },
