...
const PAGE_TITLES: Record<string, string> = {
  ...
  "/admin/objetivos": "Objetivos (OKRs)",
  "/admin/objetivos-venta": "Objetivos de venta",
  "/admin/cierre-turno": "Cierre de turno",
  "/admin/arqueos": "Arqueos",
  "/admin/conciliacion": "Conciliación",
  ...
  "/manager/objetivos-venta": "Objetivos de venta",
  "/manager/cierre-turno": "Cierre de turno",
  "/manager/arqueos": "Arqueos",
  "/empleado": "Fichar",
  ...
  "/empleado/cierre-turno": "Cierre de turno",
  "/empleado/arqueos": "Arqueos",
            ...
            >
              ...
              <DropdownMenu.Item asChild>
                <button
                  ...
                  className="flex w-full cursor-pointer items-center gap-2 rounded-md px-3 py-2 text-sm text-[var(--danger-text)] hover:bg-[var(--danger-bg)] focus:bg-[var(--danger-bg)] focus:outline-none transition-colors"
                >
