                  ...
                  <tbody>
                    {personas.map((p) => (
                      <tr key={p.id} className="border-b border-slate-100 last:border-0">
                        ...
                        <td className="px-4 py-2 text-sm text-slate-500">{p.sede ?? "—"}</td>
                        ...
                        <td className="px-4 py-2 text-sm">
                          {p.tienePin ? (
                            p.bloqueado ? (
                              <span className="text-amber-700">Bloqueado</span>
                            ) : (
                              <span className="text-emerald-700">Asignado</span>
                            )
                          ) : (
                            <span className="text-slate-400">Sin PIN</span>
                          )}
                        </td>
